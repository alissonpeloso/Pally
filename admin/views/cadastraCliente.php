<div class="content">
    <main>
        ...
        $nome = isset($_POST['field_name']) ? $_POST['field_name'] : "";
        $email = isset($_POST['field_email']) ? $_POST['field_email'] : "";
        $telefone = isset($_POST['field_phone']) ? $_POST['field_phone'] : "";
        $dtnasc = isset($_POST['field_birth']) ? $_POST['field_birth'] : "";
        $bairro = isset($_POST['field_bairro']) ? $_POST['field_bairro'] : "";
        $endereco = isset($_POST['field_address']) ? $_POST['field_address'] : "";
