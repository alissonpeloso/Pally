<div class="content">
    <!-- Conteúdo principal -->
    <section class="img-dest">
        <h1>AS <br> MELHORES <br> CALOTAS</h1>
        <p>A partir de <b>R$30,00</b></p>
        <a href="index.php?action=pedido">Peça Agora</a>
    </section>
    ...
    <main>
        <section class="main-content">
            ...
            <p>O que temos que ter sempre em mente é que o desenvolvimento contínuo de distintas formas de atuação agrega valor ao estabelecimento do levantamento das variáveis envolvidas.</p>
        </section>
        <!-- Promoções -->
        <aside id="promotions">
